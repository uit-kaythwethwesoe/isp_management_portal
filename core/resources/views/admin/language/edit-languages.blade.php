                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body table-responsive">
                            <form  action="{{route('admin.language.update', [app()->getLocale(),$language->id])}}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="code" placeholder="{{ __('Enter code') }}" value="{{  $language->code }}">
                                        @if ($errors->has('code'))
