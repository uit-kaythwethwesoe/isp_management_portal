        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.currency.store', app()->getLocale()) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" min="0" step="0.1" class="form-control" name="value" placeholder="{{ __('Value') }}" value="{{ old('value') }}">
                                            @if ($errors->has('value'))
