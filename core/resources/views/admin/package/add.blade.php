        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.package.store',app()->getLocale()) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" name="time" placeholder="{{ __('Time Ex:1month or 2 month') }}" value="{{ old('time') }}">
                                            @if ($errors->has('time'))
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="extra_days" placeholder="{{ __('Time Ex:1 day or 2 day') }}" value="{{ old('time') }}">
                                            @if ($errors->has('time'))
                                                <p class="text-danger"> {{ $errors->first('time') }} </p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="feature" class="form-control" data-role="tagsinput" placeholder="{{ __('Feature/Description') }}" value="{{ old('feature') }}" ></textarea>
