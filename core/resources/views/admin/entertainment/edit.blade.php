            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Edit Entertainment') }}</h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.entertainment.update',  $entertainment->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="w-100 mb-3 img-demo show-img" src="{{ asset('assets/front/img/'.$entertainment->icon) }}" alt="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" placeholder="{{ __('Name') }}" value="{{ $entertainment->name }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="counter" class="form-control" placeholder="{{ __('Counter') }}" value="{{ $entertainment->counter }}">
