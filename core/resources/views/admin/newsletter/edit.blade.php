                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.newsletter', app()->getLocale())}}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.newsletter.update', ['locale' => app()->getLocale(), 'id' => $newsletter->id]) }}" method="POST">
                                    @csrf
