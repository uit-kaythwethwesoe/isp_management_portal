...
<div class="content-header">
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item">{{ __('Email Configuration') }}</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Email Configuration') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.mail.config.update', app()->getLocale()) }}" method="POST">
                                    @csrf
