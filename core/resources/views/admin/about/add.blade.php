            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Add About Feature') }}</h3>
                                <div class="card-tools">
                                    <a href="{{ route('admin.about'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.about.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="feature" placeholder="{{ __('Feature') }}" value="{{ old('feature') }}">
