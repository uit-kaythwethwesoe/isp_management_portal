...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Preferential activities') }}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard',app()->getLocale()) }}"><i class="fas fa-home"></i>{{ __('Home') }}</a></li>
                    <li class="breadcrumb-item">{{ __('Preferential activities') }}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">{{ __('Add New Preferential activities') }}</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
    <form action="{{route('admin.upload_Preferential',app()->getLocale())}}" method="post" enctype="multipart/form-data" >
        @csrf
       
       <div class="row">
        <div class="col-md-6">
        <label class="col-sm-4 control-label">{{ __('Preferential Title') }}<span class="text-danger">*</span></label>
         <div class="col-sm-12">
             <input type="text" name="banner_title" required placeholder="{{ __('Enter Preferential Title') }}" value="" class="form-control" >
          </div> 
        </div>
         <div class="col-md-6">
        <label class="col-sm-4 control-label">{{ __('Upload Preferential') }}<span class="text-danger">*</span></label>
         <div class="col-sm-12">
 ...
 <section class="content">
        <div class="container-fluid">
            <a data-toggle="modal" data-target="#myModal"  style="color:#fff;" class="btn btn-success  waves-effect waves-light collapsed mb-2">{{ __('Add Preferential activities') }}</a>
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    @foreach($banner as $index=>$value)
                                     <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                         <a  href="{{route('admin.deletepreferential',[app()->getLocale(),$value->id])}}" title='Delete Banner' class="badge badge-danger"><i class="fas fa-trash"></i> </a>
                                         &nbsp;
                                        ...
                                        <div class="modal" id="myModal{{$index}}">
                                          <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                              ...
                                              <!-- Modal Header -->
                                              <div class="modal-header">
                                                <h4 class="modal-title">{{__('Upload Preferential')}}</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                              </div>
                                        
                                              <!-- Modal body -->
                                              <div class="modal-body">
                                            <form action="{{route('admin.editpreferential',app()->getLocale())}}" method="post" enctype="multipart/form-data" >
                                                @csrf
                                               ...
                                               <div class="row">
                                                ...
                                                <label class="col-sm-4 control-label">{{ __('Preferential Title') }}<span class="text-danger">*</span></label>
                                                 <div class="col-sm-12">
                                                     <input type="text" name="edit_banner_title" value="{{$value->name}}" required placeholder="{{ __('Enter Preferential Title') }}" value="" class="form-control" >
                                                  </div> 
                                                </div>
                                                 <div class="col-md-6">
                                                <label class="col-sm-4 control-label">{{ __('Upload Preferential') }}<span class="text-danger">*</span></label>
