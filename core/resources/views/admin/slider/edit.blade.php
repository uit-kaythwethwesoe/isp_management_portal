                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.slider.update',  $slider->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <p class="help-block text-info">{{ __('Upload 1920X460 (Pixel) Size image for best quality.
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name" placeholder="{{ __('Name') }}" value="{{ $slider->name }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-2 control-label">{{ __('Offer') }}<span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="offer" placeholder="{{ __('Offer') }}" value="{{ $slider->offer }}">
                                            @if ($errors->has('offer'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="desc" class="form-control" placeholder="{{ __('Description') }}" rows="7">{{ $slider->desc }}</textarea>
                                            @if ($errors->has('desc'))
