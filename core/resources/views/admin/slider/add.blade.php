                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="help-block text-info">{{ __('Upload 1920X460 (Pixel) Size image or Squre size image for best quality.
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="offer" placeholder="{{ __('Offer') }}" value="{{ old('offer') }}">
                                            @if ($errors->has('offer'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="desc" class="form-control" placeholder="{{ __('Description') }}" rows="7">{{ old('desc') }}</textarea>
                                            @if ($errors->has('desc'))
