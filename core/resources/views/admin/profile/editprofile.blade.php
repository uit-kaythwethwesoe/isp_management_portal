        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.box-header -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.updateProfile',app()->getLocale()) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <img class="w-100 mb-3 img-demo show-img" src="{{ asset('assets/front/img/'.Auth()->guard('admin')->user()->image) }}" alt="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="{{ Auth()->guard('admin')->user()->name }}" placeholder="{{ __('Full Name') }}">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="username" value="{{ Auth()->guard('admin')->user()->username }}" placeholder="{{ __('Username') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="email" value="{{ Auth()->guard('admin')->user()->email }}" placeholder="{{ __('Email') }}">
                                    @if ($errors->has('email'))
