            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1">{{ __('Add Maintenance') }}</h3>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{route('admin.store.maintainance.setting',app()->getLocale())}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="date" placeholder="{{ __('Date') }}">
                                    @if ($errors->has('date'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="from_time" placeholder="{{ __('From Time') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="to_time" placeholder="{{ __('To Time') }}">
