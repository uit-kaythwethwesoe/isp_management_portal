                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered data_table">
                            ...
                            <tr>
                                ...
                                <td>{{ $slink->url}}</td>
                                <td>
                                    <a href="{{ route('admin.editSlinks', ['locale' => app()->getLocale(), 'id' => $slink->id]) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>Edit</a>
                                    <form  id="deleteform" class="d-inline-block" action="{{ route('admin.deleteSlinks', ['locale' => app()->getLocale(), 'id' => $slink->id]) }}" method="post">
                                        @csrf
