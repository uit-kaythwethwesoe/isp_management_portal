                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.slinks', app()->getLocale()) }}" class="btn btn-success btn-sm">
                    ...
                    <!-- /.box-header -->
                    <div class="card-body">
                        <form id="slink" class="form-horizontal" action="{{ route('admin.updateSlinks', ['locale' => app()->getLocale(), 'id' => $slink->id]) }}" method="POST" onsubmit="store(event)">
                            @csrf
